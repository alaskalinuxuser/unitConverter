...
UBUNTU_TRANSLATION_DOMAIN="unitconverter.fulvio"
...
aptest.commands = bash $$PWD/unitConverter/tests/autopilot/run
aptest.depends  = sub-unitConverter

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/unitConverter/tests/unit 
unittest.depends  = sub-unitConverter
